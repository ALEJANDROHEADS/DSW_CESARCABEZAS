...
/*chatbar js start*/
    ...
    $('.displayChatbox').on('click', function() {
        var my_val = $('.heads').attr('vertical-placement');
        if (my_val == 'right') {
            var options = {
                direction: 'left'
            };
...
//$("body").append('<div class="fixed-button active">
//    < a href = "https://codedthemes.com/item/flash-able-bootstrap-admin-template/" target = "_blank" class= "btn btn-md btn-primary" >
//<i class="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To Pro</a > 
//    </div > ');
