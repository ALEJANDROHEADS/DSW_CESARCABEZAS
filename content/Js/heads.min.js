...
function RespContacto(result) {
    console.log(result);
    alert("Se ha Enviado Satisfactoriamente!. " + result); 
}
...
function EnviaContacto() {
    ...
    var StrUrl = "https://www.solisoat.com.co/SendEmail/api/Heads/Process?data={'Para':'" + EmailContacto+"','Asunto':'Realización de Contacto','Mensaje':'Se realiza Pruebas de Contacto'}";
...
function notify(from, align, icon, type, animIn, animOut, message) {
    $.growl({
        icon: icon,
        title: '   Diseno de Sitios Web 2021   <br/>',
        message: message,
        url: ''
    }, {
        element: 'body',
