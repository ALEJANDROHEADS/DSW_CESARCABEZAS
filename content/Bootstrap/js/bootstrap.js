...
!function (t, e) {
    ...
    (this, function (t, e, n) {
        ...
        var o = function (t) {
            ...
            var e = "alert", n = "bs.alert", i = "." + n, r = t.fn[e], a = {
                CLOSE: "close" + i, CLOSED: "closed" + i, CLICK_DATA_API: "click" + i + ".data-api"
            }
                , l = "alert", h = "fade", c = "show", u = function () {
                    function e(t) {
                        this._element = t;
                    }
                    var i = e.prototype;
            ...
            var e = "button", n = "bs.button", i = "." + n, r = ".data-api", o = t.fn[e], a = "active", l = "btn", h = "focus", c = '[data-toggle^="button"]', u = '[data-toggle="buttons"]', f = "input", d = ".active", _ = ".btn", g = {
                CLICK_DATA_API: "click" + i + r, FOCUS_BLUR_DATA_API: "focus" + i + r + " blur" + i + r;
            }
                , m = function () {
                    function e(t) {
                        this._element = t;
            ...
            var e = "carousel", n = "bs.carousel", i = "." + n, a = t.fn[e], l = {
                ...
                , g = "carousel", m = "active", p = "slide", v = "carousel-item-right", E = "carousel-item-left", T = "carousel-item-next", y = "carousel-item-prev", C = {
                ...
                , I = function () {
                    ...
                    return I.next = function () {
                        ...
                        , I._triggerSlideEvent = function (e, n) {
                            var i = this._getItemIndex(e), s = this._getItemIndex(t(this._element).find(C.ACTIVE_ITEM)[0]), r = t.Event(_.SLIDE, {
                            ...
                            if (e === c ? (i = E, s = T, r = f) : (i = v, s = y, r = d), u && t(u).hasClass(m)) this._isSliding = !1;
                                ...
                                if (!this._triggerSlideEvent(u, r).isDefaultPrevented() && l && u) {
                                    ...
                                    var A = t.Event(_.SLID, {
                                        relatedTarget: u, direction: r, from: h, to: g;
                                    }
                                    );
                            ...
                            if (i) {
                                ...
                                if (s && t(s).hasClass(g)) {
                                    var l = r({
                                        ...
                                        , t(s).data(), t(this).data()), h = this.getAttribute("data-slide-to");
            ...
            var e = "collapse", n = "bs.collapse", i = "." + n, a = t.fn[e], l = {
                toggle: !0, parent: ""
            }
                , h = {
                ...
                , u = "show", f = "collapse", d = "collapsing", _ = "collapsed", g = "width", m = "height", p = {
                    ...
                    return a.toggle = function () {
                        ...
                        , a.show = function () {
                            ...
                            if (!this._isTransitioning && t(this._element).hasClass(u)) {
                                ...
                                if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                                    ...
                                    if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", o.reflow(this._element), t(this._element).addClass(d).removeClass(f).removeClass(u), this._triggerArray.length) for (var s = 0;
                        ...
                        , a._getConfig = function (t) {
                            return t = r({
                                ...
                                , l, t), t.toggle = Boolean(t.toggle), o.typeCheckConfig(e, t, h), t;
                        }
            ...
            var e = "dropdown", i = "bs.dropdown", a = "." + i, l = ".data-api", h = t.fn[e], c = new RegExp("38|40|27"), u = {
                HIDE: "hide" + a, HIDDEN: "hidden" + a, SHOW: "show" + a, SHOWN: "shown" + a, CLICK: "click" + a, CLICK_DATA_API: "click" + a + l, KEYDOWN_DATA_API: "keydown" + a + l, KEYUP_DATA_API: "keyup" + a + l;
            }
                , f = "disabled", d = "show", _ = "dropup", g = "dropright", m = "dropleft", p = "dropdown-menu-right", v = "dropdown-menu-left", E = "position-static", T = '[data-toggle="dropdown"]', y = ".dropdown form", C = ".dropdown-menu", I = ".navbar-nav", A = ".dropdown-menu .dropdown-item:not(.disabled)", b = "top-start", D = "top-end", S = "bottom-start", w = "bottom-end", N = "right-start", O = "left-start", k = {
                    ...
                    return h.toggle = function () {
                        ...
                        , h._addEventListeners = function () {
                            ...
                            return n = r({
                                ...
                                , this.constructor.Default, t(this._element).data(), n), o.typeCheckConfig(e, n, this.constructor.DefaultType), n;
                        }
                        ...
                        , h._getPopperConfig = function () {
                            ...
                            if (!e || 3 !== e.which && ("keyup" !== e.type || 9 === e.which)) for (var n = t.makeArray(t(T)), s = 0;
                                s < n.length;
                                s++) {
                                var r = l._getParentFromElement(n[s]), o = t(n[s]).data(i), a = {
                                    relatedTarget: n[s];
                                }
                                    ;
                                if (o) {
            ...
            var e = "modal", n = "bs.modal", i = "." + n, a = t.fn.modal, l = {
            ...
            var e = "tooltip", i = "bs.tooltip", a = "." + i, l = t.fn[e], h = new RegExp("(^|\\s)bs-tooltip\\S+", "g"), c = {
                ...
                , d = "show", _ = "out", g = {
                    HIDE: "hide" + a, HIDDEN: "hidden" + a, SHOW: "show" + a, SHOWN: "shown" + a, INSERTED: "inserted" + a, CLICK: "click" + a, FOCUSIN: "focusin" + a, FOCUSOUT: "focusout" + a, MOUSEENTER: "mouseenter" + a, MOUSELEAVE: "mouseleave" + a;
                }
                , m = "fade", p = "show", v = ".tooltip-inner", E = ".arrow", T = "hover", y = "focus", C = "click", I = "manual", A = function () {
                    function l(t, e) {
            ...
            ), c = "fade", u = "show", f = ".popover-header", _ = ".popover-body", g = {
            ...
            var e = "scrollspy", n = "bs.scrollspy", i = "." + n, a = t.fn[e], l = {
            ...
            return t(window).on(c.LOAD_DATA_API, function () {
                for (var e = t.makeArray(t(d.DATA_SPY)), n = e.length;
                    n--;
                ) {
                    var i = t(e[n]);
            ...
            var e = "bs.tab", n = "." + e, i = t.fn.tab, r = {
                ...
                , a = "dropdown-menu", l = "active", h = "disabled", c = "fade", u = "show", f = ".dropdown", d = ".nav,  .list-group", _ = ".active", g = "> li > .active", m = '[data-toggle="tab"],  [data-toggle="pill"],  [data-toggle="list"]', p = ".dropdown-toggle", v = "> .dropdown-menu .active", E = function () {
                    function n(t) {
                        this._element = t;
                    }
                    var i = n.prototype;
